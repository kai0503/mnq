<template>
	<view id="app">
			...
			<header>
				<view class="lefts" style="position: relative;top: 15rpx;">
					<view class="left-top" style="position: relative;left: -10rpx;">
						...
						<view style="margin-right: 10px;width: 200px;"><view><image src="../../static/man.png" style="width:30px;height:30px;margin-left: 60px;position: relative;top:15px"></image><image src="../../static/women.png" style="width:30px;height: 30px;margin-left: 60px;position: relative;top:15px"></image></view></view>
						</view>
						...
						<li style="border: 3px solid gray;color: white;">{{info.manNum}}</li>
						<li style="border: 3px solid red;color: white;">{{info.womanNum}}</li>
						</ul>
					...
					<view class="left" style="position: relative;top: 0rpx;left: -10rpx;">
							<h3 style="position: relative;top: 25rpx;left: -15rpx;font-size: 37rpx;">今日交易人次</h3>
							<ul style="position: relative;top: 20rpx;">
			...
			<footer>
				<view class="left" >
					<h3 style="font-size: 25px;">今日客流趋势</h3>
					<view style="width: 100%;height: 100%;">
						<l-echart ref="dayPassenger"></l-echart>
					</view>
				</view>
				<view class="left">
					<h3 style="font-size: 25px;">本月客流趋势</h3>
					<view style="width: 100%;height: 100%;">
						<l-echart ref="monthPassenger"></l-echart>
					</view>
				</view>
				<view class="left">
					<h3 style="font-size: 25px;">7日交易额、交易数</h3>
					<view style="width: 100%;height: 90%;">
						<l-echart style="width: 100%;height: 100%;" ref="tradeAmount"></l-echart>
					</view>
				</view>
				<view class="right">
					<h3 style="font-size: 25px;">实时交易订单</h3>
					<ul class="th" style="background-color: #0b6c8a;">
						<li style="width: 25%;line-height: 45px;">商户名称</li>
						<li style="width: 25%;line-height: 45px;">商品</li>
						<li style="width: 25%;line-height: 45px;">金额</li>
						<li style="width: 25%;line-height: 45px;">时间</li>
					</ul>
						...
						<view class="scroll_box">
							<swiper class="swiper" circular="true" vertical="true" display-multiple-items="7" :autoplay="autoplay" :interval="interval" :duration="duration">
								<swiper-item  v-for="(item,index) in biaogeshuju" :key="index">
										<ul class="td">
											<li style="width: 25%;font-size: 20px;margin-left: 10px;">{{item.name}}</li>
											<li style="width: 25%;margin-left: 10px;">{{item.commodity}}</li>
											<li style="width: 25%;">{{item.money}}</li>
											<li style="width: 25%;">{{item.times}}</li>
										</ul>
								</swiper-item>
							</swiper>
						</view>
